<%@ page contentType="text/html;charset=UTF-8" language="java" %>
    ...
    <button class="w3-btn w3-hover-green w3-round-large" onclick="location.href=
  '/secondServlet'">Suppliers</button>
    <button class="w3-btn w3-hover-green w3-round-large" onclick="location.href=
  '/servlet'">servlet</button>

    <button class="w3-btn w3-hover-green w3-round-large" onclick="location.href=
   '/adminProductServlet'">adminProduct</button>
